...
{
    internal class AuthenticationFailureDAO : AbstractMongoDAO<AuthenticationFailure>
    {
        public AuthenticationFailureDAO(MongoDatabase _mongoDB)
            : base(_mongoDB)
        {
            //User
            HasParent = true;
        ...
        {
            get { return "AuthenticationFailure"; }
        }
